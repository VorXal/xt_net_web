...
namespace Task2._1._1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(CustomString.Equals(cs3, cs3));
            CustomString.PrintCustomString(cs3);
            Console.WriteLine(CustomString.GetPositionCharInCustomString('0', cs3));
            Console.WriteLine(cs3.GetPositionCharInCustomString('e'));
